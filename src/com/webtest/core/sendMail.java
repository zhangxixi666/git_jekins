...
public class sendMail {
	...
	public sendMail() throws Exception{
		//均从config.properties读取内容
		smtp = ReadProperties.getPropertyValue("smtp");//
		sender = ReadProperties.getPropertyValue("senderMail");//发送者邮箱地址
		reciever = ReadProperties.getPropertyValue("recieverMail");//接收者邮箱地址
		code = ReadProperties.getPropertyValue("Mail_code"); //发送者邮件授权码
