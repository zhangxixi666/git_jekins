...
public class MailUtil {
    ...
    static String from = "zfy";

    static String user = "wizardzxx@126.com";
    static String password = "985211zfy";
    ...
    {
    	WebTestListener w1 = new WebTestListener();
//    	System.out.println(w1.writeResultToMailTemplate());
    	MailUtil.sendEmail("517328263@qq.com", "ceshi", "ce");
